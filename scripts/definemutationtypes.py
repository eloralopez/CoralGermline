...
header = ["chrom.pos", "sample", "ref", "alt", "genotype", "DeNovo_LoH", "TiTv", "WhattoWhat", "TrueorFalse", "TypeofMutation", "PopulationPoly", "MutantParent1", "MutantParent2","MutantSperm1","MutantSperm2"]
header = '\t'.join(header)
print(header)    
popconclist = []
popaltlist = []
...
def definemutations(polymorphic, typeofmutation, specifiedgenotypes, population_dictionary):
        ...
        #                     homo2het +=1
                    ...
                    #
                                    if meltconcatenated ==concatenated:
                                        ...
                                        outlist = [meltconcatenated, meltsample, ref, alt, meltgenotypes, DeNovo_or_LoH, TiTv, WhattoWhat, TrueorFalse, TypeofMutation, PopulationPoly, MutantParent1, MutantParent2, MutantSperm1, MutantSperm2]
